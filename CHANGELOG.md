...
## [Unreleased]
## [0.0.4](https://github.com/MiyakoMeow/async-sevenz-rs/compare/v0.0.3...v0.0.4) - 2026-03-03


### Chore

- **(deps)** Update Rust crate tokio to v1.50.0 ([#18](https://github.com/MiyakoMeow/async-sevenz-rs/pull/18))
- **(deps)** Update actions/checkout action to v6 ([#17](https://github.com/MiyakoMeow/async-sevenz-rs/pull/17))
- **(deps)** Update Rust crate tempfile to v3.26.0 ([#15](https://github.com/MiyakoMeow/async-sevenz-rs/pull/15))
- **(deps)** Update Rust crate tokio to v1.49.0 ([#16](https://github.com/MiyakoMeow/async-sevenz-rs/pull/16))
- **(deps)** Update Swatinem/rust-cache action to v2.8.2 ([#9](https://github.com/MiyakoMeow/async-sevenz-rs/pull/9))
- **(deps)** Update Rust crate ppmd-rust to v1.4.0 ([#13](https://github.com/MiyakoMeow/async-sevenz-rs/pull/13))
- **(deps)** Update Rust crate lzma-rust2 to 0.16 ([#11](https://github.com/MiyakoMeow/async-sevenz-rs/pull/11))
- **(deps)** Update rust-wasm-bindgen monorepo ([#7](https://github.com/MiyakoMeow/async-sevenz-rs/pull/7))
- **(deps)** Update Rust crate async-compression to v0.4.41 ([#6](https://github.com/MiyakoMeow/async-sevenz-rs/pull/6))


### Features

- switch to release-plz ([#4](https://github.com/MiyakoMeow/async-sevenz-rs/pull/4))


### Other

- **(ci)** cleanup merged pr branch
